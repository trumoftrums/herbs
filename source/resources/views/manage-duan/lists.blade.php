...
@section('page-title', "Danh sách dự án")
...
<div class="row tab-search">
    <div class="col-md-2">
        <a href="{{ route('duanadmin.create') }}" class="btn btn-success" id="add-user">
...
//                                var_dump($IMGs);exit();
                                if(!empty($IMGs)){
                                    echo '<img src="'.$IMGs[0].'" width="100" height="50" />';
                                }
                            }
                        ...
                        <td class="text-center">
                            <a href="{{ route('duanadmin.edit', $bd->id) }}" class="btn btn-primary btn-circle edit" title="Edit"
                                    data-toggle="tooltip" data-placement="top">
                                <i class="glyphicon glyphicon-edit"></i>
                            </a>
                            <a href="{{ route('duanadmin.delete', $bd->id) }}" class="btn btn-danger btn-circle" title="Delete"
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    data-method="DELETE"
